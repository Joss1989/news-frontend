...
import type { FormData } from "@/types/types"; // Import af FormData typen for at definere formularens data
import { useYupForm } from "@/schema/Schema"; // Import af custom hook til formularstyring og validering
import { createContact } from "@/data/contactData"; // Import af funktion til at sende kontaktdata
